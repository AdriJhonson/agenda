...
import static br.com.adrisilva.agenda.view.App.exibirMenu;
...
public class InterAgenda {
    ...
    public static int exibirMenu(String storage) {
        Scanner teclado = new Scanner(System.in);
        
        System.out.println("####################################");
        System.out.println("Agenda Tarefas - " + storage);
    ...
    public static void main(String[] args) {
        try {
            ...
            InputStream is = new FileInputStream("configs.properties");
            properties.load(is);

            String config_store = properties.getProperty("store");

            if (config_store.equals("vector")) {
                AgendaVector controller = new AgendaVector();
                Scanner teclado = new Scanner(System.in);
                String desc_tarefa;

                int opcMenu = exibirMenu("Vector");
                ...
                while (opcMenu != 8) {
                    ...
                    opcMenu = exibirMenu("Vector");
                }

            } else if (config_store.equals("hashmap")) {
                AgendaHash controller = new AgendaHash();
                Scanner teclado = new Scanner(System.in);
                String desc_tarefa;

                int opcMenu = exibirMenu("HashMap");
                ...
                while (opcMenu != 8) {
                    ...
                    switch (opcMenu) {
                        case 1:
                            ...
                            System.out.print("Local: ");
                            String local = teclado.nextLine();
                            controller.cadastrarTarefa(hr_inicio, valor_hora, duracao, desc, data, local);
                            break;
